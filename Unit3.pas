...
ShowMessage('ЗАмерьте свой пульс');   Exit; end;
if ((StrToInt(Edit4.Text) < 60) or (StrToInt(Edit4.Text) >80) ) then
ShowMessage('Уважаемый(-ая) '  + edit5.Text + '. Ваш пульс находится за пределами нормы. Обратитесь к врачу.');
if (Edit5.Text = '' ) then begin
ShowMessage('Введите ФИО');     Exit; end;
